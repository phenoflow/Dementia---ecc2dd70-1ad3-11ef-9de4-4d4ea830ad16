...
steps:
  ...
  organic-dementia---primary:
    run: organic-dementia---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  dementia-paranoia---primary:
    run: dementia-paranoia---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: organic-dementia---primary/output
  dementia-picks---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: dementia-paranoia---primary/output
  dementia---primary:
  ...
  dementia-brain---primary:
    run: dementia-brain---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  dementia-delirium---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: dementia-brain---primary/output
  output-cases:
